...
// import { PacketId, PacketIn, PacketOut } from '@forts/resilience4ts-core';
...
export class ServerTCP extends Server {
  ...
  private readonly socketClass!: Type<any>;
  ...
  //   readSocket.on(MESSAGE_EVENT, async (msg: PacketIn & PacketId) =>
  ...
  //       const outgoingResponse = this.serializer.serialize(data as PacketOut & PacketId);
